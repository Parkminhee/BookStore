...
<div id="jumbotron" class="container">
	<div class="jumbotron jumbotron-info" style="background-color:lightgray;">
		...
		<p>KW BOOKSTORE 회원가입을 진심으로 환영합니다.</p>
	</div>
	
	<div class="container">
		<form id="joinFrm" action="${context}/kw/user/createUser.do" method="post" role="form">
			<div class="form-horizontal">
				<hr/>
				<div class="form-group" style="margin-top:5%;">
					<label for="id" class="control-label col-md-2"><b>아이디</b></label>
					<div class="col-md-4">
						<input class="form-control" type="text" name="id" id="id" required="required" autofocus="autofocus" onkeyup="fn_idCheck()" />
					</div>
					<p id="message"></p>
				...
				<div class="form-group">
					...
					<div class="col-md-1">
						<button class="btn btn-primary" type="button" name="btnSubmit" id="btnSubmit" onclick="fn_join()">등록하기</button>
					</div>
				</div>
			</div>			
		</form>
